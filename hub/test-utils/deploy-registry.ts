/**
 * Shared test helper for the anvil-backed mqtt-auth-service integration suites.
 *
 ...
 */
// Deliberately dependency-free (no viem import): this helper lives under hub/,
// outside package node_modules, so it must resolve nothing but Bun + Node built-ins.
// Callers bring their own viem.
