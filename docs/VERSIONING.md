...
| `@clanker-chain/clanker-cli` | `clanker-cli-v2026.9.8` |
...
5. `@clanker-chain/clanker-cli` — **`2026.9.8`** (Foundry key export, post-mint OpenClaw wire, doctor hub health, closed-beta invite)
