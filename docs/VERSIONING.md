...
| `@clanker-chain/clanker-cli` | `clanker-cli-v2026.9.12-1` |
...
5. `@clanker-chain/clanker-cli`. **`2026.9.12-1`** (join→CLI attach: `fund --address`, read-only setup first, honest signer errors)
