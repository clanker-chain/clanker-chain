...
Broker stack (not on this host unless noted): 192.168.1.197 — Anvil, identity :8080, mqtt-auth :9090, MQTT :1883.
...
- Reachability:
  - `curl -fsS http://192.168.1.197:8080/health`
  - `curl -fsS http://192.168.1.197:8080/v1/bots/<BOT_ID>` (status + secp256k1 public_key only)
  - `curl -fsS http://192.168.1.197:9090/health`
